...
ALLOWED_HOSTS = env.list('DJANGO_ALLOWED_HOSTS', default=['rgram.ap-northeast-2.elasticbeanstalk.com'])
...
#    default='rgram <noreply@trashking.net>'
# )
# https://docs.djangoproject.com/en/dev/ref/settings/#server-email
# SERVER_EMAIL = env('DJANGO_SERVER_EMAIL', default=DEFAULT_FROM_EMAIL)
# https://docs.djangoproject.com/en/dev/ref/settings/#email-subject-prefix
# EMAIL_SUBJECT_PREFIX = env('DJANGO_EMAIL_SUBJECT_PREFIX', default='[rgram]')
