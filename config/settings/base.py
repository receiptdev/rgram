...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgresql://postgres:1234@localhost:5432/rgram'),
}
...
MIGRATION_MODULES = {
    'sites': 'rgram.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Seungjoon Yang""", 'receipt.defy@me.com'),
]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'rgram.users.adapters.SocialAccountAdapter'
